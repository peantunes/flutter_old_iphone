...
class IPhoneIconInfo {
  ...
  String image;
  Widget widget;
  IPhoneIconInfo({this.name, this.image, this.widget});
}
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  final List<IPhoneIconInfo> content = [
    IPhoneIconInfo(name:'Calendar', widget:CalendarAppIconWidget()),
    IPhoneIconInfo(name:'Clock', widget:ClockAppIconWidget()),
    IPhoneIconInfo(name:'SMS', image:'resources/images/iPhoneIcons/sms-iPhone1-icon.png'),
    IPhoneIconInfo(name:'Photos', image:"resources/images/iPhoneIcons/photos-iPhone1-icon.png"),
    IPhoneIconInfo(name:'Camera', image:'resources/images/iPhoneIcons/camera-iPhone1-icon.png'),
    IPhoneIconInfo(name:'Youtube', image:"resources/images/iPhoneIcons/youtube-iPhone1-icon.png"),
    IPhoneIconInfo(name:'Stocks', image:'resources/images/iPhoneIcons/stocks-iPhone1-icon.png'),
    IPhoneIconInfo(name:'Maps', image:'resources/images/iPhoneIcons/maps-iPhone1-icon.png'),
  ...
  final List<IPhoneIconInfo> bottomIcons = [
    IPhoneIconInfo(name:'Phone', image:'resources/images/iPhoneIcons/phone-iPhone1-icon.png'),
    IPhoneIconInfo(name:'Mail', image:"resources/images/iPhoneIcons/mail-iPhone1-icon.png"),
